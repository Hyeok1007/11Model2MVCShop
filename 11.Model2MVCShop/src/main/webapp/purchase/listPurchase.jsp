...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr class="ct_list_pop">
		...
		<% if(list.get(i).getTranCode().trim().equals("2")) { %>
			<td align="left"><<a href="/updateTranCode.do?tranNo=<%=list.get(i).getTranNo() %>&tranCode=3">물건도착</a></td>
		<% } %>
	</tr>
	<% } %>
	<tr>
	...
	<tr>
		<td align="center">
			...
			<% if(resultPage.getBeginUnitPage() != 1) { %>
				<a href="/listPurchase.do?page=<%=resultPage.getBeginUnitPage()-1 %>">이전&nbsp;</a> 
		 	<% } %>
		 ...
		 <% if(resultPage.getEndUnitPage() != resultPage.getMaxPage()) {%>
			<a href="/listPurchase.do?page=<%=resultPage.getEndUnitPage()+1 %>">&nbsp;다음</a>
		<%} %> 
